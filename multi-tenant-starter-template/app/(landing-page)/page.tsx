    ...
    return (
      <div className="w-full min-h-96 flex items-center justify-center">
        <div className="max-w-xl gap-4">
          <p className="font-bold text-xl">Ambiente de teste</p>
          <br />
          <p className="">
            {
              "Esse aqui é um projeto teste para verificar o poder de customização do Stack Auth. E incorporalo no Payload CMS."
            }
          </p>
        </div>
      </div>
